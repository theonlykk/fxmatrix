//+------------------------------------------------------------------+
//| fxmatrix_v2_unified_gbpusd.mq5 — thin GBPUSD unified V2 shell    |
//| Production fxmatrix_v2.mq5 remains untouched until parity gate.  |
//+------------------------------------------------------------------+
#property copyright "fxmatrix"
#property version   "2.23"
#property strict

#include "fxmatrix_v2_preset_gbpusd.mqh"
...
input int    InpEurCapThreshold   = 0;    // compile-compat; unused on GBPUSD
...
input double InpDumbRefBandPips   = 3.0;   // dumb arm: legacy input (unused post-ADR-123)
