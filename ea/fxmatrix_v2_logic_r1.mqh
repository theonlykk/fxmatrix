//+------------------------------------------------------------------+
//| fxmatrix_v2_logic_r1.mqh — shared V2 helpers (Phase 1, no geometry)|
//| Production fxmatrix_v2_logic.mqh unchanged; refactored EAs use this.|
//+------------------------------------------------------------------+
#ifndef FXMATRIX_V2_LOGIC_R1_MQH
#define FXMATRIX_V2_LOGIC_R1_MQH

#include "fxmatrix_v2_geometry.mqh"
...
#endif // FXMATRIX_V2_LOGIC_R1_MQH
