//+------------------------------------------------------------------+
//| fxmatrix_v2_eurusd_ref.mq5 — Phase 1 refactor (EURUSD preset, parity: fxmatrix_v2_eurusd.mq5)
...
int OnInit() {
   ...
   Print("INFO: fxmatrix_v2_eurusd_ref init MM_LONG_V2=", MM_LONG_V2,
