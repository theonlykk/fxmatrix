...
void Test_Q10_RetryMissingExitsOnlyUncovered()
{
   ...
   AssertTrue("Q10 rank2 exit survives", g_grind_long.layers[1].exit_order_ticket == 7001);
...
void Test_SB4_EntExitGoesToFilledPosition()
{
   ...
   AssertTrue("SB4 old exit survives", g_grind_short.layers[0].exit_order_ticket == 3001);
