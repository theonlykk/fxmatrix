...
void Test_MQ3_TrimRunsBeforeRelease()
{
   ...
   const ulong mq3_exit_far = 6101;
   const ulong mq3_exit_mid2 = 6102;
   const ulong mq3_exit_mid1 = 6103;

   ArrayResize(g_grind_long.layers, 4);
   Adr151_TestSetupLongLayer(g_grind_long, 0, 0, 1.10500, 5001, mq3_exit_far);
   Adr151_TestSetupLongLayer(g_grind_long, 1, 1, 1.10400, 5002, mq3_exit_mid2);
   Adr151_TestSetupLongLayer(g_grind_long, 2, 2, 1.10300, 5003, mq3_exit_mid1);
   Adr151_TestSetupLongLayer(g_grind_long, 3, 3, 1.10200, 5004, 0);
   Grind_OrderTestUpsert(mq3_exit_far, (long)22260101UL,
                         GrindCommentBuild("OPT", "L", 0, "EXT"),
                         1.10530, (long)ORDER_TYPE_SELL_LIMIT);
   Grind_OrderTestUpsert(mq3_exit_mid2, (long)22260101UL,
                         GrindCommentBuild("OPT", "L", 1, "EXT"),
                         1.10430, (long)ORDER_TYPE_SELL_LIMIT);
   Grind_OrderTestUpsert(mq3_exit_mid1, (long)22260101UL,
                         GrindCommentBuild("OPT", "L", 2, "EXT"),
                         1.10330, (long)ORDER_TYPE_SELL_LIMIT);
