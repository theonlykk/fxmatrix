...
void Long_OnNewBar() {
   ...
   if (n == 0) {
      ...
      if(Long_ReplacePendingBuy(g_long_l0_ticket, bid_lvl, 20260901, "V2_L0")) {
...
void Short_OnNewBar() {
   ...
   if (n == 0) {
      ...
      if(Short_ReplacePendingSell(g_short_l0_ticket, offer_lvl, 20260902, "V2_L0")) {
...
int OnInit() {
   if(InpEaseDepthFull <= InpEaseDepthStart || InpEaseDepthStart < 0 || InpEaseDepthFull < 0) {
      Print("ERROR: fxmatrix_v2 invalid ease depth inputs — InpEaseDepthStart=",
