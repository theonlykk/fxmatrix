//+------------------------------------------------------------------+
//| VERIFY ONLY: SpreadMultiplier=0.125 test copy of fxmatrix_v2_eurusd.mq5
//| EURUSD production dual — do not deploy to live/VPS.
...
input double InpSpreadMultiplier  = 0.125;  // SM0125 verify (production default 0.500)
