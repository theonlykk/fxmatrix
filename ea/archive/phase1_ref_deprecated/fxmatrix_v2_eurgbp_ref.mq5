//+------------------------------------------------------------------+
//| fxmatrix_v2_eurgbp_ref.mq5 — Phase 1 refactor (EURGBP preset, parity: fxmatrix_v2_eurgbp.mq5)
...
int OnInit() {
   ...
   Print("INFO: fxmatrix_v2_eurgbp_ref init AB-signal MM_LONG_V2=", MM_LONG_V2,
